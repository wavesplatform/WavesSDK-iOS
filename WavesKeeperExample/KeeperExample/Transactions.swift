...
extension ViewController {
    ...
    func txInvokeScript(chainId: String) -> NodeService.Query.Transaction.InvokeScript {
        ...
        let queryModel = NodeService.Query.Transaction.InvokeScript.init(chainId: chainId,
                                                                         fee: fee,
                                                                         feeAssetId: "WAVES",
                                                                         dApp: dApp,
    ...
    func txData(chainId: String) -> NodeService.Query.Transaction.Data {
        ...
        let queryModel = NodeService.Query.Transaction.Data.init(fee: fee,
    ...
    func txDataError(chainId: String) -> NodeService.Query.Transaction.Data {
        let queryModel = NodeService.Query.Transaction.Data.init(fee: 0,
                                                                 timestamp: 0,
                                                                 senderPublicKey: "",
                                                                 data: [],
                                                                 chainId: chainId)
    ...
    func txBurn(chainId: String) -> NodeService.Query.Transaction.Burn {
        ...
        let queryModel = NodeService.Query.Transaction.Burn.init(chainId: chainId,
                                                                 fee: fee,
